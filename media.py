...
class Movie(object):
    ...
    Attributes:
        ...
        id: A string to store the id to indentify the number of Movie objects created.
        ...
        backdrop_path: A string to store url of the backdrop image of the movie.
    """


    def __init__(self, title, image_url, storyline, id, movie_id, movie_release_date, backdrop_path):
        self.title = title
